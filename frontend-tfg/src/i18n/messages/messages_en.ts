const translations = {
    /* ******************** proxy ******************** */
    'proxy.exceptions.Error': 'Unexpected error',
    'proxy.exceptions.NetworkErrorException': 'Failure while connection with server',
    'proxy.exceptions.ServiceException': 'Service error',
    ...
    'common.fields.surname': 'Surnames',
    'common.fields.email': 'Email',
    'common.fields.nickname': 'Nickname',
    ...
    'app.components.Header.userActions.editProfile': 'Edit profile',


    /* ******************** Users ******************** */
    'users.components.SignUp.title': 'Sign up',
    'users.components.SignUp.signUpButton': 'Sign up',
    'users.componentes.SignUp.confirmPasswordError': 'Check that passwords do match',
    'users.components.Login.title': 'Login',
    'users.components.Login.loginButton': 'Login',
    'users.components.Login.signUpEncouragementText': 'You still do not have an account?',
    'users.components.ChangePassword.title': 'Change password',
    'users.components.ChangePassword.oldPassword': 'Old password',
    'users.components.ChangePassword.newPassword': 'New password',
    'users.components.ChangePassword.confirmNewPassword': 'Repeat the new password',
    'users.components.ChangePassword.changePassword': 'Change password',
    'users.components.UpdateProfile.title': 'Update profile',
